...
const translations = {
  en: {
    'hero.title': 'MAMMAD MAMADOV',
    'hero.subtitle': 'Innovator. Entrepreneur. Visionary.',
    'about.title': 'About Me',
    'about.content': 'Being born in Azerbaijan i cultivated dedication to my work in all aspects since i was born. In my 30s i\'ve been thriving as a director of meet factory and later decided to open an own restaurant in the center of Baku. After that i\'ve been living in Dubai and providing my professional guidance as a real estate agent to many influencial people.',
  ...
  ru: {
    'hero.title': 'МАММЕД МАМАДОВ',
    'hero.subtitle': 'Инноватор. Предприниматель. Визионер.',
    'about.title': 'Обо мне',
    'about.content': 'Будучи предпринимателем-визионером с более чем десятилетним опытом, я посвятил свою карьеру расширению границ предпринимательства и созданию значимого влияния через взаимодействие с людьми.',
